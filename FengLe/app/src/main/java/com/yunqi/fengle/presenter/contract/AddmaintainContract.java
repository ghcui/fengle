...
public interface AddmaintainContract {
    interface View extends BaseView {
    }

    interface Presenter extends BasePresenter<AddmaintainContract.View> {
        void doAddMaintain(AddMaintainRequest request, ResponseListener listener);
