...
public class NoticeAdapter extends BaseQuickAdapter<NoticeResponse,BaseViewHolder>{

    public NoticeAdapter(List<NoticeResponse> data) {
        super(R.layout.item_message,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, NoticeResponse item) {
